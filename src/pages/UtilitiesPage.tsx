        ...
        <div className="max-w-6xl mx-auto space-y-12">
            ...
            <div className="p-8">
              <div className="grid md:grid-cols-2 gap-6 mb-6">
                <div>
                  ...
                  <input type="text" value={amount} onChange={e => setAmount(e.target.value)} className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#FF6B00] text-lg font-semibold" />
                </div>
                <div>
                  <label className="block text-sm font-semibold text-gray-700 mb-2">
                    Dari
                  </label>
                  <select value={fromCurrency} onChange={e => setFromCurrency(e.target.value)} className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#FF6B00] text-lg font-semibold">
              ...
              <div className="grid md:grid-cols-2 gap-6 mb-6">
                <div>
                  ...
                  <div className="w-full px-4 py-3 bg-gray-50 border border-gray-300 rounded-lg text-lg font-bold text-[#FF6B00]">
                    {result}
                  </div>
                </div>
                <div>
                  ...
                  <select value={toCurrency} onChange={e => setToCurrency(e.target.value)} className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#FF6B00] text-lg font-semibold">
                    <option value="USD">USD - US Dollar</option>
                    <option value="IDR">IDR - Rupiah Indonesia</option>
                    <option value="EUR">EUR - Euro</option>
                    <option value="GBP">GBP - British Pound</option>
              ...
              <button className="w-full bg-[#FF6B00] hover:bg-[#e66000] text-white font-bold py-3 rounded-lg transition-colors">
                Konversi
              </button>
          ...
          <div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
              ...
              return <motion.div key={i} initial={{
                ...
                delay: i * 0.1
              }} className={`bg-gradient-to-br ${tool.color} text-white p-6 rounded-lg cursor-pointer hover:shadow-xl transition-all group`}>
          ...
          <div>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              delay: i * 0.1
                  ...
                  <button className="w-full mt-4 px-4 py-2 bg-gray-100 hover:bg-[#FF6B00] hover:text-white text-gray-700 font-semibold rounded transition-colors flex items-center justify-center gap-2">
          ...
          <div className="bg-gradient-to-r from-gray-900 to-gray-800 text-white rounded-lg p-8">
            ...
            <div className="grid md:grid-cols-3 gap-4">
              <a href="https://www.bi.go.id" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 p-4 bg-white/10 rounded-lg hover:bg-white/20 transition-colors">
                <ExternalLink className="w-4 h-4" />
                <span>Bank Indonesia</span>
              </a>
              <a href="https://www.idx.co.id" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 p-4 bg-white/10 rounded-lg hover:bg-white/20 transition-colors">
                <ExternalLink className="w-4 h-4" />
                <span>Bursa Efek Indonesia</span>
              </a>
              <a href="https://www.ojk.go.id" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 p-4 bg-white/10 rounded-lg hover:bg-white/20 transition-colors">
                <ExternalLink className="w-4 h-4" />
                <span>OJK</span>
              </a>
            </div>
